...
private:
    ...
    // for debug:
    // trace the time of mediacodec queueinputbuffer to outputbufferavaliable.
    bool mRecordDelay;
    struct TraceBitStreamToFrameDelay{
        int64_t mQueueInputputBufferT;
        int64_t mOnQueueInputputBufferT;
        int64_t mOutputBufferAvaliT;
        int64_t mDeQueueOutputBufferT;
        int64_t mHandleDeQueueOutputBufferT;
        int64_t mReleaseOutputBufferT;
    };
    std::map<int64_t, TraceBitStreamToFrameDelay> mMapB2FDalay;
